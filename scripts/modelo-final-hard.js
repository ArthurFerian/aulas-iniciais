...
let aplicativoMaiorDowloads = aplicativos[0];
...
for (let i = 0; i < aplicativos.length; i ++) {
    if (downloads[i] > maiorNumeroDowloads) {
        ...
        aplicativoMaiorDowloads = aplicativos[i]; 
    }
    ...
    if (categorias[i]=== "Social") {
        totalDowloadsSocial += downloads[i];
    }
...
console.log(`O aplicativo com maior número de dowloads é: ${aplicativoMaiorDowloads}! da categoria: ${categoriaMaiorDowloads}! `);

console.log(`O aplicativo com a maior avaliação é: ${aplicativoMaiorAvaliacao} da categoria ${categoriaMaiorAvaliacao}`);

console.log(`A média de dowloads dos aplicativos é: ${mediaDowloads}milhões`);

console.log(`Os aplicativos com mais de 4.5 estrelas de avaliação são ${novoArray}`);

console.log(`O total de dowloads da categoria social é ${totalDowloadsSocial}M`);
